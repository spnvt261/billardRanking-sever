package com.billard.BillardRankings.constant;
...
public class ResourceName {
    ...
    public static final String ELO_HISTORY = "EloHistory";
    public static final String MATCH_SCORE_EVENT = "MatchScoreEvent";
